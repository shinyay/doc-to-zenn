...
4月1日〜8日は**23件のアップデート**がありました。Copilotクラウドエージェントの署名付きコミット対応、GPT-5.1 Codex廃止、Copilot SDK パブリックプレビュー開始など、AIエージェント機能の本格展開が加速しています。
<!-- INTRO_END -->
...
<!-- /DAILY_ENTRY:2026-04-08 count=6 -->
...
<!-- /DAILY_ENTRY:2026-04-03 count=4 -->
...
<!-- /DAILY_ENTRY:2026-04-02 count=7 -->
...
<!-- /DAILY_ENTRY:2026-04-01 count=6 -->
